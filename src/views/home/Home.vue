  ...
  <el-container style="border: 1px solid #eee; min-height: 100%;">
    <el-aside style="background-color: #545c64;width:auto;">
      ...
      <el-container>
        <el-header>
          <!-- 点击切换收起左侧菜单 -->
          <el-button @click="isMenuCollapse= !isMenuCollapse" style="font-size:
            24px;padding: 5px 8px;">
    ...
    <script>
import {getUser,getGlobalData, clearGlobalData} from 'utils/globalData';
